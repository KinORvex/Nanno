...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        *_timestamp_columns(),
        ...
        sa.Column("status", experiment_status_enum, nullable=False, server_default="planning"),
    ...
    op.create_table(
        ...
        *_timestamp_columns(),
        ...
        sa.Column("health_status", health_status_enum, nullable=False, server_default="unknown"),
